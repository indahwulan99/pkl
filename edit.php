...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #6a99ff">
  ...
  <div class="row">
    <div class="col-md-12">
    <center><h2>EDIT DATA INDUSTRI</h2></center><br>
    <?php
      foreach ($db->edit($_GET['nib']) as $data){
    ?>  
    <form action = "proses.php?aksi=update" method="post">
 	<div class="form-row">
    <div class="form-group col-md-4">
      <label for="inputnib">NIB</label>
      <input type="text" readonly name = "nib" value="<?php echo $data['nib']?>" class="form-control" id="inputnib" placeholder="NIB">
    </div>
	<div class="form-group col-md-4">
      <label for="inputnk">NIK</label>
      <input type="text" name = "nik" value="<?php echo $data['nik']?>" class="form-control" id="inputnk" placeholder="nik">
    </div>
    <div class="form-group col-md-4">
      <label for="inputnp">Nama Pemilik</label>
      <input type="text" name = "nama" value="<?php echo $data['nama']?>" class="form-control" id="inputnp" placeholder="Nama Pemilik">
    </div>
    <div class="form-group col-md-4">
      <label for="inputnamaind">Nama Industri</label>
      <input type="text" name = "namaind" value="<?php echo $data['namaind']?>" class="form-control" id="inputnamaind" placeholder="Nama Industri">
    </div>
    <div class="form-group col-md-4">
      <label for="inputnamaprod">Nama Produk</label>
      <input type="text" name = "namaproduk" value="<?php echo $data['namaproduk']?>" class="form-control" id="inputnamaprod" placeholder="Nama Produk">
    </div>
    <div class="form-group col-md-4">
      <label for="inputhn">Tahun</label>
      <input type="text" name = "tahun" value="<?php echo $data['tahun']?>" class="form-control" id="inputhn" placeholder="Tahun">
    </div>
    <div class="form-group col-md-4">
        <label for="inputmo">Skala</label>
    ...
    <div class="form-group col-md-4">
      ...
      <select class="form-control" name="inthn" id="inputinv">
        ...
        <option value="1.000.000.000 - 15.000.000.000">1.000.000.000 - 15.000.000.000</option>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name = "alamatind" value="<?php echo $data['alamatind']?>" class="form-control" id="inputalind" placeholder="Alamat Industri">
    </div>
	<div class="form-group col-md-4">
      <label for="inputem">email</label>
      <input type="text" name = "email" value="<?php echo $data['email']?>" class="form-control" id="inputem" placeholder="Email">
    </div>
	<div class="form-group col-md-4">
      <label for="inputal">Alamat</label>
      <input type="text" name = "alamat" value="<?php echo $data['alamat']?>" class="form-control" id="inputal" placeholder="Alamat">
    </div>
    <div class="form-group col-md-4">
      <label for="inputsos">Sosial Media</label>
      <input type="text" name = "sosmed" value="<?php echo $data['sosmed']?>" class="form-control" id="inputsos" placeholder="Sosial Media">
    </div>
    <div class="form-group col-md-4">
	...
	<select name="inputkec" value="<?php echo $data['namakec']?>" class="form-control" id="inputkec">
		<?php
			foreach($db->tampil_kec() as $data) {
		?>
			<option value="<?php echo $data['id_kec'];?>"> <?php echo $data['namakec'];?> </option>
		<?php } ?>
	</select>
    </div>
  </div>  
