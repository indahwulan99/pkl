...
<center><marquee direction="up" scrollamount="2" align="center" behavior="alternate" width="90%"><marquee direction="right" 
behavior="alternate"><h3> SLOGAN DINAS PERDAGANGAN KABUPATEN KEDIRI </h3></marquee></marquee></center>
	
<div class = "jumbotron pr-5 pl-10" style="background-color :#e4f2f2">
	<div class="row mt-auto">
		<div class = "col-md-7">
			<h1 class="display-3">Selamat Datang</h1>
			<p class = "lead">Di halaman utama </p>
			<hr class="my-4">
			<p>Website Resmi Dinas Perdagangan Kabupaten Kediri</p>
		</div>
			<div class="col-lg-5" >
			<video width="500" height="400" controls autoplay>
			<source src="pkl.mp4" type="video/mp4" />
			</video>
			</div>
	</div>
</div>
