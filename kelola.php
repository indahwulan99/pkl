...
<div class="row">
<div class="col-md-12">
    <center><h4>INPUT DATA INDUSTRI</h4></center><br>
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name = "namaind" class="form-control" id="inputnamaind" placeholder="Nama Industri">
    </div>
    <div class="form-group col-md-4">
      <label for="inputnamaprod">Nama Produk</label>
      <input type="text" name = "namaproduk"class="form-control" id="inputnamaprod" placeholder="Nama Produk">
    </div>
	<div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name = "alamatind" class="form-control" id="inputalind" placeholder="Alamat Industri">
    </div>
	<div class="form-group col-md-4">
    ...
    <div class="form-group col-md-4">
      ...
      <input type="text" name = "sosmed" class="form-control" id="inputsos" placeholder="Sosial Media">
    </div>
	<div class="form-group col-md-4">
