...
class database
{
    ...
    function tampil_data1()
    {
     ...
     // INSERT DATA
    function input($nib, $namaind, $namaproduk,  $tahun, $pendthn, $inthn, $pekerja, $alamatind, $nik, $nama, $email, $alamat, 
        $sosmed,$telp, $inputkec){
   ...
   function edit($nib)
   {
    ...
    //update
function update($nib, $nik, $nama, $namaind, $namaproduk, $tahun, $pendthn, $inthn, $pekerja,
    $alamatind, $email, $alamat,  $sosmed, $telp, $inputkec){
