    ...
    <div class="container col-md-5" style = "background-color : #6a99ff" >
      <form class="form-signin" method="post" action=""><br>
        ...
        <center>
          ...
          <input type="text" id="username" class="form-control" placeholder="Username" name="username" required autofocus></center><br>
          <center><p>
            <label for="password" class="sr-only">Password</label>
            <input type="password" id="password" class="form-control" placeholder="Password" name="password" required></p>
